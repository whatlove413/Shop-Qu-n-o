...
<div class="qmbox qm_con_body_content qqmail_webmail_only" id="mailContentContainer" style="">
    ...
    <div class="contaner">
        <div class="title">XÁC NHẬN TÀI KHOẢN SHARINGECONOMY</div>
        <div class="content">
            ...
            <div class="xboxcontent">
                <div class="neirong">
                    ...
                    <div class="line">
                        <p>Điền mã kích hoạt hoặc Nhấp vào đường dẫn dưới đây để hoàn tất quá trình đăng ký: </p>
                        <span id="yzm" style="border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;"><pre>{{route('web::activeWithoutCode',(str_replace("/", "slash", (encrypt($token)))))}}</pre></span>
